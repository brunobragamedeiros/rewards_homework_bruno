...
#     assert amount_points_after_redeem > amount_points_after_un_redeem, f"Expected the amount of redeemed points after redeeming {amount_points_after_redeem} to be higher than {amount_points_after_un_redeem}"
